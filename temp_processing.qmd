...
tag16Plot <- ggplot(tag16_323, aes(x = dateTime_EST, y = temp, color = temp)) +
  geom_line() +
...
# Plot the temperature data
tag19Plot <- ggplot(tag19_329, aes(x = dateTime_EST, y = temp, color = temp)) +
  geom_line() +
  scale_color_gradient(low = "blue", high = "red", limits = c(colorMin, colorMax)) +  # Set colors for low and high temperatures
...
# Plot the temperature data
tag22Plot <- ggplot(tag22_320, aes(x = dateTime_EST, y = temp, color = temp)) +
  geom_line() +
  scale_color_gradient(low = "blue", high = "red", limits = c(colorMin, colorMax)) +  # Set colors for low and high temperatures
...
# Plot the temperature data
tag23Plot <- ggplot(tag23_322, aes(x = dateTime_EST, y = temp, color = temp)) +
  geom_line() +
  scale_color_gradient(low = "blue", high = "red", limits = c(colorMin, colorMax)) +  # Set colors for low and high temperatures
...
# Plot the temperature data
tag24Plot <- ggplot(tag24_319, aes(x = dateTime_EST, y = temp, color = temp)) +
  geom_line() +
  scale_color_gradient(low = "blue", high = "red", limits = c(colorMin, colorMax)) +  # Set colors for low and high temperatures
...
# Plot the temperature data
tag27Plot <- ggplot(tag27_303, aes(x = dateTime_EST, y = temp, color = temp)) +
  geom_line() +
  scale_color_gradient(low = "blue", high = "red", limits = c(colorMin, colorMax)) +  # Set colors for low and high temperatures
...
# Plot the temperature data
tag28Plot <- ggplot(tag28_306, aes(x = dateTime_EST, y = temp, color = temp)) +
  geom_line() +
  scale_color_gradient(low = "blue", high = "red", limits = c(colorMin, colorMax)) +  # Set colors for low and high temperatures
...
# Plot the temperature data
tag29.1Plot <- ggplot(tag29.1_325, aes(x = dateTime_EST, y = temp, color = temp)) +
  geom_line() +
  scale_color_gradient(low = "blue", high = "red", limits = c(colorMin, colorMax)) +  # Set colors for low and high temperatures
...
# Plot the temperature data
tag29Plot <- ggplot(tag29_304, aes(x = dateTime_EST, y = temp, color = temp)) +
  geom_line() +
  scale_color_gradient(low = "blue", high = "red", limits = c(colorMin, colorMax)) +  # Set colors for low and high temperatures
...
# Plot the temperature data
tag30.1Plot <- ggplot(tag30.1_319, aes(x = dateTime_EST, y = temp, color = temp)) +
  geom_line() +
  scale_color_gradient(low = "blue", high = "red", limits = c(colorMin, colorMax)) +  # Set colors for low and high temperatures
...
# Plot the temperature data
tag31Plot <- ggplot(tag31_302, aes(x = dateTime_EST, y = temp, color = temp)) +
  geom_line() +
  scale_color_gradient(low = "blue", high = "red", limits = c(colorMin, colorMax)) +  # Set colors for low and high temperatures
...
# Plot the temperature data
tag32Plot <- ggplot(tag32_298, aes(x = dateTime_EST, y = temp, color = temp)) +
  geom_line() +
  scale_color_gradient(low = "blue", high = "red", limits = c(colorMin, colorMax)) +  # Set colors for low and high temperatures
...
# Plot the temperature data
tag33Plot <- ggplot(tag33_305, aes(x = dateTime_EST, y = temp, color = temp)) +
  geom_line() +
  scale_color_gradient(low = "blue", high = "red", limits = c(colorMin, colorMax)) +  # Set colors for low and high temperatures
...
# Plot the temperature data
tag34Plot <- ggplot(tag34_296, aes(x = dateTime_EST, y = temp, color = temp)) +
  geom_line() +
  scale_color_gradient(low = "blue", high = "red", limits = c(colorMin, colorMax)) +  # Set colors for low and high temperatures
...
# Plot the temperature data
tag36Plot <- ggplot(tag36_301, aes(x = dateTime_EST, y = temp, color = temp)) +
  geom_line() +
  scale_color_gradient(low = "blue", high = "red", limits = c(colorMin, colorMax)) +  # Set colors for low and high temperatures
...
# Plot the temperature data
tag37Plot <- ggplot(tag37_308, aes(x = dateTime_EST, y = temp, color = temp)) +
  geom_line() +
  scale_color_gradient(low = "blue", high = "red", limits = c(colorMin, colorMax)) +  # Set colors for low and high temperatures
...
# Plot the temperature data
tag38Plot <- ggplot(tag38_315, aes(x = dateTime_EST, y = temp, color = temp)) +
  geom_line() +
  scale_color_gradient(low = "blue", high = "red", limits = c(colorMin, colorMax)) +  # Set colors for low and high temperatures
...
# Plot the temperature data
tag40Plot <- ggplot(tag40_312, aes(x = dateTime_EST, y = temp, color = temp)) +
  geom_line() +
  scale_color_gradient(low = "blue", high = "red", limits = c(colorMin, colorMax)) +  # Set colors for low and high temperatures
...
# Plot the temperature data
tag42Plot <- ggplot(tag42_325, aes(x = dateTime_EST, y = temp, color = temp)) +
  geom_line() +
  scale_color_gradient(low = "blue", high = "red", limits = c(colorMin, colorMax)) +  # Set colors for low and high temperatures
...
# Plot the temperature data
tag43Plot <- ggplot(tag43_309, aes(x = dateTime_EST, y = temp, color = temp)) +
  geom_line() +
  scale_color_gradient(low = "blue", high = "red", limits = c(colorMin, colorMax)) +  # Set colors for low and high temperatures
...
# Plot the temperature data
tag46.1Plot <- ggplot(tag46.1_317, aes(x = dateTime_EST, y = temp, color = temp)) +
  geom_line() +
  scale_color_gradient(low = "blue", high = "red", limits = c(colorMin, colorMax)) +  # Set colors for low and high temperatures
...
# Plot the temperature data
tag46Plot <- ggplot(tag46_317, aes(x = dateTime_EST, y = temp, color = temp)) +
  geom_line() +
  scale_color_gradient(low = "blue", high = "red", limits = c(colorMin, colorMax)) +  # Set colors for low and high temperatures
...
# Plot the temperature data
tag52Plot <- ggplot(tag52_326, aes(x = dateTime_EST, y = temp, color = temp)) +
  geom_line() +
  scale_color_gradient(low = "blue", high = "red", limits = c(colorMin, colorMax)) +  # Set colors for low and high temperatures
...
# Plot the temperature data
tag54Plot <- ggplot(tag54_328, aes(x = dateTime_EST, y = temp, color = temp)) +
  geom_line() +
  scale_color_gradient(low = "blue", high = "red", limits = c(colorMin, colorMax)) +  # Set colors for low and high temperatures
...
# Plot the temperature data
tag57Plot <- ggplot(tag57_337, aes(x = dateTime_EST, y = temp, color = temp)) +
  geom_line() +
  scale_color_gradient(low = "blue", high = "red", limits = c(colorMin, colorMax)) +  # Set colors for low and high temperatures
...
# Plot the temperature data
tag60Plot <- ggplot(tag60_338, aes(x = dateTime_EST, y = temp, color = temp)) +
  geom_line() +
  scale_color_gradient(low = "blue", high = "red", limits = c(colorMin, colorMax)) +  # Set colors for low and high temperatures
...
# Plot the temperature data
tag62Plot <- ggplot(tag62_334, aes(x = dateTime_EST, y = temp, color = temp)) +
  geom_line() +
  scale_color_gradient(low = "blue", high = "red", limits = c(colorMin, colorMax)) +  # Set colors for low and high temperatures
