...
for (file_name in fish_file_names) {
  ...
  trackingData <- rawTrackingData %>%
    ...
    select(dckyID, habitat, position, substrate, shade, Notes, amthID, undhID, 
           dryuID, habitatExtra, substrateExtra, signal, x, y, dateTime, shift, brookName) %>%
...
fishStream1 <- left_join(fishSurvey1, streamSurvey1, by = c("shift", "riverMatch" = "river"))

# Remove the 'riverMatch' column from the result
fishStream1 <- fishStream1 %>% select(-riverMatch)
...
# Perform the join on the 'shift' and the modified 'riverMatch' column in the fish survey
fishStream2 <- left_join(fishSurvey2, streamSurvey2, by = c("shift", "riverMatch" = "river"))

# Remove the 'riverMatch' column from the result
fishStream2 <- fishStream2 %>% select(-riverMatch)
...
# Perform the join on the 'shift' and the modified 'riverMatch' column in the fish survey
fishStream3 <- left_join(fishSurvey3, streamSurvey3, by = c("shift", "riverMatch" = "river"))

# Remove the 'riverMatch' column from the result
fishStream3 <- fishStream3 %>% select(-riverMatch)
...
# Perform the join on the 'shift' and the modified 'riverMatch' column in the fish survey
fishStream4 <- left_join(fishSurvey4, streamSurvey4, by = c("shift", "riverMatch" = "river"))

# Remove the 'riverMatch' column from the result
fishStream4 <- fishStream4 %>% select(-riverMatch)
...
# Perform the join on the 'shift' and the modified 'riverMatch' column in the fish survey
fishStream5 <- left_join(fishSurvey5, streamSurvey5, by = c("shift", "riverMatch" = "river"))

# Remove the 'riverMatch' column from the result
fishStream5 <- fishStream5 %>% select(-riverMatch)
...
# Perform the join on the 'shift' and the modified 'riverMatch' column in the fish survey
fishStream6 <- left_join(fishSurvey6, streamSurvey6, by = c("shift", "riverMatch" = "river"))

# Remove the 'riverMatch' column from the result
fishStream6 <- fishStream6 %>% select(-riverMatch)
...
# Perform the join on the 'shift' and the modified 'riverMatch' column in the fish survey
fishStream7 <- left_join(fishSurvey7, streamSurvey7, by = c("shift", "riverMatch" = "river"))

# Remove the 'riverMatch' column from the result
fishStream7 <- fishStream7 %>% select(-riverMatch)
...
# Perform the join on the 'shift' and the modified 'riverMatch' column in the fish survey
fishStream8 <- left_join(fishSurvey8, streamSurvey8, by = c("shift", "riverMatch" = "river"))

# Remove the 'riverMatch' column from the result
fishStream8 <- fishStream8 %>% select(-riverMatch)
...
# Perform the join on the 'shift' and the modified 'riverMatch' column in the fish survey
fishStream9 <- left_join(fishSurvey9, streamSurvey9, by = c("shift", "riverMatch" = "river"))

# Remove the 'riverMatch' column from the result
fishStream9 <- fishStream9 %>% select(-riverMatch)
...
# Perform the join on the 'shift' and the modified 'riverMatch' column in the fish survey
fishStream10 <- left_join(fishSurvey10, streamSurvey10, by = c("shift", "riverMatch" = "river"))

# Remove the 'riverMatch' column from the result
fishStream10 <- fishStream10 %>% select(-riverMatch)
...
# Perform the join on the 'shift' and the modified 'riverMatch' column in the fish survey
fishStream11 <- left_join(fishSurvey11, streamSurvey11, by = c("shift", "riverMatch" = "river"))

# Remove the 'riverMatch' column from the result
fishStream11 <- fishStream11 %>% select(-riverMatch)
...
flowWeek1 <- bind_rows(flowWeek1, amethyst_combined)
...
# Bind the AMETHYST rows to the original dataset
flowWeek2 <- bind_rows(flowWeek2, amethyst_combined)
...
# Bind the AMETHYST rows to the original dataset
flowWeek3 <- bind_rows(flowWeek3, amethyst_combined)
...
# Bind the AMETHYST rows to the original dataset
flowWeek4 <- bind_rows(flowWeek4, amethyst_combined)
...
# Bind the AMETHYST rows to the original dataset
flowWeek5 <- bind_rows(flowWeek5, amethyst_combined)
...
# Bind the AMETHYST rows to the original dataset
flowWeek6 <- bind_rows(flowWeek6, amethyst_combined)
...
# Bind the AMETHYST rows to the original dataset
flowWeek7 <- bind_rows(flowWeek7, amethyst_combined)
...
# Bind the AMETHYST rows to the original dataset
flowWeek8 <- bind_rows(flowWeek8, amethyst_combined)
...
# Bind the AMETHYST rows to the original dataset
flowWeek9 <- bind_rows(flowWeek9, amethyst_combined)
...
# Bind the AMETHYST rows to the original dataset
flowWeek10 <- bind_rows(flowWeek10, amethyst_combined)
...
# Bind the AMETHYST rows to the original dataset
flowWeek11 <- bind_rows(flowWeek11, amethyst_combined)
